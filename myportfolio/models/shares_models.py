...
class shareIds(models.Model):
    ...
    wkn = models.CharField(max_length=MAX_LENGTH_WKN, default = "None", blank=True, unique=True)
    isin = models.CharField(max_length=MAX_LENGTH_ISIN, default = "None", blank=True, unique=True)
